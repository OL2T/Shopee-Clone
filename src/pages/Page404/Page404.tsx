...
export default function Page404() {
  return (
    <>
      <Helmet>
        <title>Trang 404 | Shopee Clone</title>
        <meta name='description' content='Trang 404 dự án Shopee Clone' />
      </Helmet>
      <div className='pt-16 text-center mt-auto h-[100vh]'>
        <img
          alt='404'
        ...
        />
        <div className='_1UfFg'>
          <p className='font-medium text-gray-600 my-3 text-xl'>404</p>
        ...
        <div className='DQJcZ'>
          <Link
            to={path.home}
            className='inline-flex items-center justify-center rounded-sm bg-orange text-white text-sm text-center min-w-[150px] min-h-10 py-2 px2.5 mt-4'
          >
